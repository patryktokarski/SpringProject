...
<%@ tag description="Authentication Main Layout" pageEncoding="UTF-8" %>
...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<c:url value="/webjars/AdminLTE/2.4.2/plugins/iCheck/square/blue.css"/>">
...
<body class="hold-transition login-page" style="background: darkcyan">
