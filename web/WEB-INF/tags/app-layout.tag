...
<div class="wrapper">
    ...
    <jsp:include page="/WEB-INF/views/application/partials/header.jsp"/>

    <!-- Left side column. contains the logo and sidebar -->
    <aside class="main-sidebar">
        <!-- sidebar: style can be found in sidebar.less -->

        <jsp:include page="/WEB-INF/views/application/partials/sidebar.jsp"/>
    ...
    <jsp:include page="/WEB-INF/views/application/partials/footer.jsp"/>

    <!-- Control Sidebar -->

    <jsp:include page="/WEB-INF/views/application/partials/settings.jsp"/>
